...
build/PA1 testcases/scene24_dof.txt output/scene24_dof2.bmp $METHOD $SAMPLES
...
# build/PA1 testcases/scene36_hall_of_fame2.txt output/scene36_hall_of_fame_5.bmp $METHOD $SAMPLES
# build/PA1 testcases/scene38.txt output/scene38.bmp $METHOD $SAMPLES