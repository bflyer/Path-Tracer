...
# build/PA1 testcases/scene22_cow_texture.txt output/scene22_cow_texture2.bmp $METHOD $SAMPLES
...
build/PA1 testcases/scene25_glossy.txt output/scene25_glossy3.bmp $METHOD $SAMPLES
