...
void Matrix3f::inverseInplace( bool* pbIsSingular, float epsilon )
{
	...
	else
	{
		...
		( *this )( 0, 0 ) = cofactor00 * reciprocalDeterminant;
		( *this )( 0, 1 ) = cofactor10 * reciprocalDeterminant;
		( *this )( 0, 2 ) = cofactor20 * reciprocalDeterminant;

		( *this )( 1, 0 ) = cofactor01 * reciprocalDeterminant;
		( *this )( 1, 1 ) = cofactor11 * reciprocalDeterminant;
		( *this )( 1, 2 ) = cofactor21 * reciprocalDeterminant;

		( *this )( 2, 0 ) = cofactor02 * reciprocalDeterminant;
		( *this )( 2, 1 ) = cofactor12 * reciprocalDeterminant;
		( *this )( 2, 2 ) = cofactor22 * reciprocalDeterminant;
		return;
	}
}
