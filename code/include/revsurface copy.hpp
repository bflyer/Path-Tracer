...
// //     //     cout << "t = " << t << endl;
// //     //     getUV(r, t, theta, mu);
// //     //     cout << t << " theta: " << theta / (2 * M_PI) << " mu: " << mu << "---------------------" << endl;
...
// //     //     cout << "cp.V: "; cp.V.print();
// //     //     cout << "cp.T: "; cp.T.print();
// //     //     pt = rotMat * cp.V;
// //     //     dmu = rotMat * cp.T;
// //     //     dtheta = Vector3f(-cp.V.x() * sin(theta), 0, -cp.V.x() * cos(theta));
// //     //     cout << "pt: "; pt.print();
// //     //     cout << "dmu: "; dmu.print();
// //     //     cout << "dtheta: "; dtheta.print();
// //     //     return pt;
// //     // }
// //         bool intersect(const Ray &r, Hit &h, double tmin) override {
// //         float theta, mu;
